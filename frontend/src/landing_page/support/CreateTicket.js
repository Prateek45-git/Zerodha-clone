        ...
        <div className='container'>
            <div className='row p-5 mt-5 mb-5'>
                ...
                <div className='col-lg-4 p-5 mt-2 mb-2'>
                    <h4 className='fs-5 text-muted'><i class="fa fa-plus-circle" aria-hidden="true"></i> Account Opening</h4>
                ...
                <div className='col-lg-4 p-5 mt-2 mb-2'>
                    <h4 className='fs-5 text-muted'><i class="fa fa-user" aria-hidden="true"></i> Your Zerodha Account</h4>
                ...
                <div className='col-lg-4 p-5 mt-2 mb-2'>
                    <h4 className='fs-5 text-muted'><i class="fa fa-bar-chart" aria-hidden="true"></i> Your Zerodha Account</h4>
                    <a href='' style={{textDecoration: "none", lineHeight: "2.5"}}>Margin/levrage, Product and Order types</a><br />
                ...
                <div className='col-lg-4 p-5 mt-2 mb-2'>
                    <h4 className='fs-5 text-muted'><i class="fa fa-credit-card" aria-hidden="true"></i> Funds</h4>
                ...
                <div className='col-lg-4 p-5 mt-2 mb-2'>
                    <h4 className='fs-5 text-muted'><i class="fa fa-circle-o-notch" aria-hidden="true"></i> Console</h4>
                ...
                <div className='col-lg-4 p-5 mt-2 mb-2'>
                    <h4 className='fs-5 text-muted'><i class="fa fa-circle-thin" aria-hidden="true"></i> Coin</h4>
